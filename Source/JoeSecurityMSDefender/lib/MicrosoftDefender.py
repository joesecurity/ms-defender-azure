...
from .Models import Evidence, LiveResponse
...
class MicrosoftDefender:
    ...
    def enrich_alerts(
        self, evidence: Evidence, sample_data: dict, enrichment_sections: list
    ) -> None:
        """
        ...
        :param enrichment_sections: list of section to enrich the alert
