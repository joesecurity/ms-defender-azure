...
from .lib.joeSecurity import JoeSecurity
...
def run(
    ...
    if not JOE_CONFIG.RESUBMIT:
        for evidence in found_evidences.values():
            ...
            if sample_data["detection"] in GENERAL_CONFIG.SELECTED_VERDICTS:
...
def process_url(
    download_evidences: dict, joe_security: JoeSecurity, threat_family: str
) -> list:
    """
    Process URL
...
def process_submissions(
    joe_security: JoeSecurity, ms_defender: MicrosoftDefender, submissions: list
) -> None:
    """
